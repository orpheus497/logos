...
def test_get_logos_banner_contains_logos():
    """##Function purpose: Verify get_logos_banner contains block characters.."""
    ##Action purpose: Get LOGOS banner
    banner = get_logos_banner()
    banner_text = "\n".join(banner)

    ##Condition purpose: Verify banner contains block characters
    assert "█" in banner_text or "▒" in banner_text
