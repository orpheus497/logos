...
def test_agent_full_prompt():
    ...
    agent = Agent(
        name="Test Agent", desc="Test", group="A", base_prompt="Base: ", activation_prompt="Activation", purpose="Test"
    )
...
def test_agent_slots():
    ...
    agent = Agent(name="Test", desc="Test", group="A", base_prompt="", activation_prompt="", purpose="")
